...
<div class="card card-outline card-info rounded-0">
	...
	<div class="card-body">
		<form action="" id="cab-form">
			...
			<div class="form-group">
				<label for="cab_reg_no" class="control-label">Plate No /Vehicle Reg No</label>
			...
			<div class="form-group">
				<label for="body_no" class="control-label">Cab's Body Color</label>
			...
			<div class="form-group">
				<label for="driver_contact" class="control-label">Driver's Phone Number </label>
